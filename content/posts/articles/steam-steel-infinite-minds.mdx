...
Right: Pittsburgh steel factories during the Gilded Age.右图：镀金时代的匹兹堡钢铁厂。*](G8y8wl3W0AAba3S.jpg)
...
![Early movies often looked like stage plays, with one camera focused on the stage.早期的电影通常看起来像舞台剧，镜头始终固定在舞台上。](G8y9M4OW0AA0v9Q.jpg)
...
![The most popular form of AI today looks like Google search of the past. To quote Marshall McLuhan: "we are always driving into the future via the rearview window."今天最流行的 AI 形式看起来就像过去的 Google 搜索。引用麦克卢汉的话：“我们总是通过后视镜驶入未来。”](G8y9U07W0AA-N1g.jpg)
...
![A 1970s Scientific American study on locomotion efficiency inspired Steve Jobs's famous "bicycle for the mind" metaphor. Except we've been pedaling on the Information Superhighway for decades since.1970 年代《科学美国人》关于运动效率的一项研究，激发了史蒂夫·乔布斯著名的“大脑的自行车”这一比喻。只是此后的几十年里，我们一直在“信息高速公路”上蹬车。](G8y-btoXEAAC2dn.jpg)
...
![Compared with coding agents, why is it more difficult for AI to help with knowledge work? Because knowledge work is more fragmented and less verifiable.与编程代理相比，为什么 AI 辅助知识工作更难？因为知识工作更加碎片化，且更难验证。](G8y-0DPWsAA-fCD.jpg)
...
![The Red Flag Act of 1865 required a flag bearer to walk ahead of the vehicle while it drove down the street (repealed in 1896). An example of undesirable "human in the loop."1865 年的《红旗法案》要求在车辆行驶时，必须有一名旗手在车前步行引导（该法案于 1896 年废除）。这就是一个“不理想的人在环路中”的例子。](G8y_Q1UWcAAV08O.jpg)
...
![A wonder of steel: the Woolworth building was the tallest building in the world upon completion in NYC, 1913.](G8zBGwyW0AI2S0F.jpg)
...
![A mill with a water wheel to power its operations. Water was powerful but unreliable and restricted mills to a few locations and seasonality.](G8zBVOTWsAAHsF9.jpg)
...
![This 1835 engraving by Thomas Allom depicts a textile factory in Lancashire, UK. It was powered by steam engines.](G8zBgWaXAAArTM_.jpg)
...
![G8zC4gTWUAA8ZcP.jpg](G8zC4gTWUAA8ZcP.jpg)
